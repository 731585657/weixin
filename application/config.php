...
return  [
	...
	// | 系统数据加密设置
	// +----------------------------------------------------------------------
	'data_auth_key' => 'erZBN/t(,*X+=4.7g`n{8V1hP?%of;LIqz}^s[Yv', //默认数据加密KEY
	'data_cache_key'=> 'erZBN/t(,*X+=4.7g`n{8V1hP?%of;LIqz}^s[Yv',
    // +----------------------------------------------------------------------
    // | UCenter客户端配置
    // +----------------------------------------------------------------------
    'uc_app_id'   => 1,   //应用ID
    'uc_api_type' =>'Model',    //可选值 Model / Service
    'uc_auth_key' =>'erZBN/t(,*X+=4.7g`n{8V1hP?%of;LIqz}^s[Yv', //加密KEY
